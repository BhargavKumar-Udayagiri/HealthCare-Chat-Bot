...
training = pd.read_csv('D:/HEALTHCARE/models/Training.csv')
testing= pd.read_csv('D:/HEALTHCARE/models/Testing.csv')
...
def getDescription():
    ...
    with open('D:/HEALTHCARE/models/symptom_Description.csv') as csv_file:
...
def getSeverityDict():
    ...
    with open('D:/HEALTHCARE/models/symptom_severity.csv') as csv_file:
...
def getprecautionDict():
    ...
    with open('D:/HEALTHCARE/models/symptom_precaution.csv') as csv_file:
...
def sec_predict(symptoms_exp):
    df = pd.read_csv('D:\HEALTHCARE\models\Training.csv')
    X = df.iloc[:, :-1]
    y = df['prognosis']
